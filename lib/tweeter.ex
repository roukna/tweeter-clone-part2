defmodule Tweeter do
  ...
  @delay 5
  @moduledoc """
  Tweeter keeps the contexts that define your domain
  and business logic.
  ...
  def start_simulation(no_of_clients, list_of_static_hashtags, active_users, list_of_socket_ids) do
    ...
    [active_users, new_active_users] = Tweeter.maintain_connect_disconnect(no_of_clients, active_users, list_of_socket_ids)
    Process.sleep(500)
  ...
  def main(args) do  
    ...
    list_of_socket_ids = for n <- 1..no_of_clients do
      ...
      {:ok, socket} = connect(TweeterWeb.UserSocket, %{})
      {:ok, _, socket} = subscribe_and_join(socket, "tweeter", %{})
    ...
    # Subscribe all users
    subscribe_all_user = Tweeter.subscribe_all_user(no_of_clients, list_of_socket_ids)
